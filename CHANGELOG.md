...
## 1.2.9 — 2026-06-17
- Сохранение черновиков комментариев и постов.
- Проверка орфографии в текстовых полях.
- Автокапитализация предложений.
- Размытие (blur) навигационной панели.
- Исправлено падение при выборе изображения.
- Исправлено двойное открытие файлового менеджера.
- Исправлена ошибка при отправке отчётов о падениях.
